...
void buscar_codigo(){
	...
	do{
	   if(estudiante.codigo == cod)	{
	   	cout<<"Codigo del Estudiante: "<<estudiante.codigo<<endl;
	   	cout<<"Nombres del Estudiante: "<<estudiante.nombre<<endl;
	   	cout<<"Apellidos del Estudiante: "<<estudiante.apellido<<endl;
	   	cout<<"Telefono del Estudiante: "<<estudiante.telefono<<endl;
	   	cout<<"Direccion del Estudiante: "<<estudiante.direccion<<endl;
	   }
	   fread(&estudiante,sizeof(Estudiante),1,archivo);	
